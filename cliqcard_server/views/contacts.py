...
from cliqcard_server.models import Group, GroupMember
...
class ContactsView(MethodView):
    """
    Views that shows all cards that are currently shared with the current user.
    """
    ...
    def get(self):
        ...
        for group_member in group_members:
            if group_member.user not in users and group_member.user != request.user:
